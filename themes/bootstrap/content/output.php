...
/**********************************************/
?>
<div class="span8" id="post_output">
	<article>
		<header>
	...
	<aside id="post_tools">
				...
				<div class="post_actions">
					...
					<a href="#toggleFlag" 
						data-flag="favorite" data-active="Favorite" title="Mark as a favorite" data-inactive="Mark as Favorite" data-content="<?= $doc->id; ?>" 
						class="flag btn btn-mini <? if ($doc->hasFlag('favorite',$POD->currentUser())) {?>active<? } ?>"> Favorite
					</a>
					<a href="#toggleFlag" data-flag="watching" data-active="Tracking" title="Track new comments on the dashboard" data-inactive="Track"
						data-content="<?= $doc->id; ?>" class="flag btn btn-mini <? if ($doc->hasFlag('watching',$POD->currentUser())) {?>active<? } ?>"> Track
					</a>
				
					<? if ($doc->isEditable()) { ?>
						<a href="<? $doc->write('editlink'); ?>" title="Edit this post" class="edit_button btn-mini btn-link pull-right">Edit</a>
					<? } ?>
				</div>
			<? } ?>
	</aside>
