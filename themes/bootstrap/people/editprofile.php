...
?>
	...
	<div class="contentPadding span12">
		...
		<form id="edit_profile" method="post" action="<? $POD->siteRoot(); ?>/editprofile"  class="valid" enctype="multipart/form-data">
			...
			<p class="input"><label>&nbsp;</label><button type="submit" class="btn btn-primary" value="Update my account">Update my account</button></p>
		</form>
		...
		<form id="change_password" method="post" action="<? $POD->siteRoot(); ?>/editprofile" class="valid">
			...
			<p class="input"><label>&nbsp;</label><button class="btn" type="submit" value="Set New Password">Set New Password</button></p>	
